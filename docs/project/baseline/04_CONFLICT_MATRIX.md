...
| CONFLICT-04 | 需求附录提到“五个一级页面”，页面清单又列出首页、对话、知识库列表、知识库详情、文件详情、历史会话、设置等层级 | 页面范围、UI Scope、验收 | 采用 DEC-G3-001：五个一级页面壳，详情页嵌套，设置页延后 | RESOLVED_DEC-G3-001 |
...
已经有用户决策的冲突可按上述裁决进入当前项目决策基线。CONFLICT-04 已由 DEC-G3-001 裁决；CONFLICT-07、CONFLICT-08、CONFLICT-10 仍需在 G6/G8/G9.5 等相应阶段复核。
